document.addEventListener('DOMContentLoaded', function () {
  const faqToggles = document.querySelectorAll('.section--faqs--faq--toggle')
  ...
  function toggleFaq(toggle) {
    const thisGroup = toggle.closest('.section--faqs--faq')
    const thisContent = thisGroup.querySelector('.section--faqs--faq--content')
