function sizeSectionLandingPageTestimonialColumnsDividers() {
	setTimeout(function () {
		const sections = document.querySelectorAll('.section--lptestimonialcolumns--hasdividers')

		sections.forEach(function (thisSection) {
			const firstColumn = thisSection.querySelector('.section--lptestimonialcolumns--column:nth-child(1)')
			const thisSectionColumnVerticalPadding = (firstColumn.offsetHeight - firstColumn.clientHeight) / 2

			const dividers = thisSection.querySelectorAll('.section--lptestimonialcolumns--divider--vertical')
			dividers.forEach((divider) => {
				divider.style.height = ''
				divider.style.margin = ''
			})

			const columnBodies = thisSection.querySelectorAll('.section--lptestimonialcolumns--column--body, .section--coulumns--column--body--content')
			...
			let rowHeights = []
			let contentHeights = []
			let totalColumns = thisSection.querySelectorAll('.section--lptestimonialcolumns--column').length
			let columnWidths = {}
			const thisColumns = thisSection.querySelector('.section--lptestimonialcolumns--grid')
			...
			const columns = thisSection.querySelectorAll('.section--lptestimonialcolumns--column')
			columns.forEach(function (column, index) {
				const thisHeight = column.querySelector('.section--lptestimonialcolumns--column--body').offsetHeight
				const contentHeight = column.querySelector('.section--lptestimonialcolumns--column--body--content').offsetHeight
				let rowIndex
			...
			columns.forEach(function (column, index) {
				...
				const body = column.querySelector('.section--lptestimonialcolumns--column--body')
...
document.addEventListener('DOMContentLoaded', function () {
	sizeSectionLandingPageTestimonialColumnsDividers()
})
