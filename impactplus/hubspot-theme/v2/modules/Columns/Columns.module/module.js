  ...
  setTimeout(function () {
    ...
    sections.forEach(function (thisSection) {
      const firstColumn = thisSection.querySelector(
        '.section--columns--column:nth-child(1)'
      )
      ...
      const columnBodies = thisSection.querySelectorAll(
        '.section--columns--column--body, .section--coulumns--column--body--content'
      )
      ...
      columns.forEach(function (column, index) {
        const thisHeight = column.querySelector(
          '.section--columns--column--body'
        ).offsetHeight
        const contentHeight = column.querySelector(
          '.section--columns--column--body--content'
        ).offsetHeight
        let rowIndex
